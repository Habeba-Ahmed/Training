...
// import 'package:e_commerci/feature/auth/presentation/cubit/supabase/auth_cubit.dart';
...
//     return BlocProvider(
//       create: (context) => AuthCubitSupaBase(),
//       child: Scaffold(
...
//             BlocConsumer<AuthCubitSupaBase, AuthStateSupaBase>(
...
//               context.read<AuthCubitSupaBase>().updatePassword(passwordController.text,confirmpasswordController.text,email);
//             });
//               },
//             )
